...
/**
 * Class which is used for making the conclusion based on the input data using Zadeh's min operator.
 *
 * @author goran
 * @version 1.0
 */
public class AccelerationConclusionMin implements Conclusion {
    /**
     ...
     */
    public AccelerationConclusionMin(Defuzzifier defuzzifier) throws InvalidNameException {
